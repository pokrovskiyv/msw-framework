...
## 9. Операционные обязательства (сводка)

| Обязательство | Моё конкретное правило | Инструмент контроля |
|---|---|---|
| 1. Еженедельная сессия стратегирования | Каждое [день недели] в [время], 60 мин, неотменяемо | Защищённый слот в календаре |
| 2. Повестка сессии | Ретро → смыслы → стратегия/проекты → план недели → разбор заметок | Чек‑лист в экзокортексе (раздел 5.2) |
| 3. Время на приоритетные проекты | Не менее 10 ч/нед., защищённые слоты | Календарь, трекер времени |
| 4. Публичная демонстрация | Каждую неделю минимум 1 артефакт | Площадка публикации + реестр (табл. 8.1) |
| 5. Ревью от проверяющего | Каждую неделю: 1 абзац + 3 улучшения | Проверяющий/peer (имя: [укажите]) |
| 6. Работа с окружением | 5–13 касаний/нед. + обновление карты раз/мес. | Таблица 6.2 (CRM) |
| 7. Энергобюджет и восстановление | Сон ≥49 ч/нед.; shutdown-ритуал ежедневно | Таблица 7.1, 7.3 (журнал состояния) |
