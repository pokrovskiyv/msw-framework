...
| **Уровень мастерства** | Ученик / Профессионал / Мастер | Профессионал |
...
| **Оценка мастерства** | Нет или абстрактно | Есть уровень (Junior/Middle/Senior) | Есть уровень + обоснование (почему так оценил) |
...
A: Должность "Системный аналитик" — это пакет, который может включать несколько ролей: Сборщик требований, Модел ировщик процессов, Фасилитатор воркшопов, Документер спецификаций. Различение помогает понять, какие **именно** способности развивать.
