...
**Рабочий продукт недели:** Личный контракт v4.0 — Устойчивая система (энергобюджет + регламент восстановления + слоты в календаре)
**Версия:** 1.0
...
4. **Собрать Личный контракт v4.0:**
   ...
   - Добавить энергобюджет и регламент восстановления как обязательные разделы
...
Упрощения:
- Энергобюджет: 5–7 ключевых блоков времени
...
Критерий «зачёт»: Контракт v4.0 собран, энергобюджет и регламент заполнены, слоты забронированы, журнал ведётся (≥4 записи).

### Полный трек (10–12 часов на неделю)

Полные требования:
- Энергобюджет: детально по блокам (сон, работа, проекты, обучение, спорт, досуг, социальное)
...
graph TB
    ...
    G --> H[Устойчивость: энергобюджет и восстановление<br/>🎯 НЕДЕЛЯ 8]
...
Что делает:
- Строит энергобюджет недели и регламент восстановления
...
Что делает:
- Объясняет модель энергобюджета и регламента восстановления
...
Собрать и опубликовать **Личный контракт v4.0** с разделами «Энергобюджет», «Регламент восстановления», «Журнал состояния» и «Риски/маркеры».

Состав артефакта недели:
- Таблица 8.1 — энергобюджет (план/минимум/факт)
...
Отлично:
- Полный энергобюджет; соблюдение сон‑окна ≥5/7
...
- «Как я проектирую устойчивую неделю»: one‑pager/пост с энергобюджетом и регламентом (обезличенно)
